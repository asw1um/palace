...
import { Compass, Film, Search, SlidersHorizontal, Sparkles, Tv, Wand2 } from 'lucide-react';
...
export default function Discover() {
  ...
  useEffect(() => {
    if (!loading) staggerIn(gridRef.current?.querySelectorAll('.poster'), { y: 18, each: 22, scale: 0.96 });
  }, [loading, kind, genre, sort, debounced]);
  ...
  return (
    <>
      ...
      {didYouMean && (
        <div className="panel panel--inset row gap-2" style={{ padding: 'var(--sp-3)' }}>
                ...
                <Poster
                  ...
                  footer={
                    <div className="stack gap-1">
                      ...
                      <div className="row gap-2 faint" style={{ fontSize: 'var(--fs-11)' }}>
