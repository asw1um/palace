...
export default function NotificationsPage() {
  ...
  useEffect(load, []);
  useEffect(() => {
    if (!loading) staggerIn(document.querySelectorAll('.notif-row'), { y: 10, each: 26 });
  }, [loading, tab]);
          ...
          <div className="stack gap-1" style={{ padding: 'var(--sp-2)' }}>
            {shown.map((n) => (
              <div
                ...
                style={{
                  background: n.is_read ? undefined : 'var(--accent-softer)',
              ...
              >
                ...
                <div className="grow" style={{ minWidth: 0 }}>
                  <div className="row gap-2">
                    <strong style={{ fontSize: 'var(--fs-13)' }}>{n.title}</strong>
