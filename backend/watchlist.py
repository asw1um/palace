...
from dbstruct import db, user, movie, show, show_season, movielist, ShowProgress, MovieProgress
...
@watchlist.route('/progress/<int:show_id>', methods=['GET'])
@jwt_required()
...
@watchlist.route('/progress', methods=['POST'])
@jwt_required()
def update_progress():
    user_id = int(get_jwt_identity())
    data = request.get_json()
...
@watchlist.route('/all-progress', methods=['GET'])
@jwt_required()
...
@watchlist.route('/movie-progress/<int:movie_id>', methods=['GET'])
@jwt_required()
...
@watchlist.route('/movie-progress', methods=['POST'])
@jwt_required()
